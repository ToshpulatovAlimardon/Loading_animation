...
setInterval(() => {
    ...
    setTimeout(() => {
        ...
        a.length === 1
            ...
            : a.length === 2
            ? (divs[3].style.color = "blue")
            : a.length === 3
            ? (divs[3].style.color = "green")
            : "";
        setTimeout(() => {
    ...
    setTimeout(() => {
        ...
        a.length === 1
            ...
            : a.length === 2
            ? (divs[4].style.color = "blue")
            : a.length === 3
            ? (divs[4].style.color = "green")
            : "";
        setTimeout(() => {
    ...
    setTimeout(() => {
        ...
        a.length === 1
            ...
            : a.length === 2
            ? (divs[5].style.color = "blue")
            : a.length === 3
            ? (divs[5].style.color = "green")
            : "";
        setTimeout(() => {
    ...
    setTimeout(() => {
        ...
        a.length === 1
            ? (divs[6].style.color = "red")
            : a.length === 2
            ? (divs[6].style.color = "blue")
            : a.length === 3
            ? (divs[6].style.color = "green")
            : "";
        setTimeout(() => {
